...
<div class="col-md-8">
    @foreach($phones as $phone)
        <div class="input-group mb-15 js_panel_multiple-row" data-name="phone">
    ...
    @endforeach
    <div class="input-group mb-15 js_panel_multiple-row js_panel_multiple-row-clone" data-name="phone">
        <div class="input-group-addon"><i class="fa fa-phone"></i></div>
